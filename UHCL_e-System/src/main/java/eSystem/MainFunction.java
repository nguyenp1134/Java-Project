...
public class MainFunction {
	...
	//STUDENT FUNCTION
	//STUDENT E-SERVICE
	protected ArrayList<Course> StudentE_CourseDisplay(String id, String major)
	{
		Session session = sessionFactory.openSession();
		session.beginTransaction();		
	...
	public void StudentE_Register(String id, String major, int n)
	{
		Session session = sessionFactory.openSession();
		session.beginTransaction();	
		...
		else
		{
			...
			{			
				if(n == i )
				{
					...
					System.out.println("A course is added to your schedule");
